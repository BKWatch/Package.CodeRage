...
/**
 * Defines the class CodeRage\Access\Test\SuiteCat
 * 
 * File:        CodeRage/Access/Test/SuiteCat.php
...
class SuiteCat extends SuiteAnimal {
    ...
    {
        return parent::createImpl($name, $color, $owner, 'cat');
    }
    public static function load($nameOrId)
    {
        return parent::loadImpl($nameOrId, 'cat');
    }
}
