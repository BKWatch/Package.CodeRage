...
/**
 * Defines the class CodeRage\Build\Test\Target\Foo.
 *
 * File:        CodeRage/Build/Test/Target/Foo.php
...
class Foo extends Basic {
    ...
    /**
     * Constructs a CodeRage\Build\Test\Target\Foo.
     *
    ...
    function __construct($status, $id = null, $dependencies = [],
        $info = null)
    {
        parent::__construct('foo', $status, $id, $dependencies, $info);
    }
}
