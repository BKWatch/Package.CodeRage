...
class Error extends Exception {
    ...
    /**
     * Path to the automatically generated status code definitions file, if any,
     * relative to the project root
     *
     * @var string
     */
    public const STATUS_CODES_PATH = '.coderage/error.php';
    ...
    {
        return self::statusCodes()[$code]['message'] ?? self::DEFAULT_MESSAGE;
    }
    ...
    /**
     * Returns the associative array of status code definitions, loading it if
     * necessary
     */
    private static function statusCodes() : array
    {
