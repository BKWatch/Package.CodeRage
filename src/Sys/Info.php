...
/**
 * Defines the class CodeRage\Sys\Info
 *
 * File:        CodeRage/Sys/Info.php
...
class Info {
    ...
    /**
     * The copyright information for this CodeRage\Sys\Info
     *
     * @var string
     */
    private $copyright;
    ...
    /**
     * Constructs a CodeRage\Sys\Info.
     *
     ...
     * <li>copyright - The copyright information for the CodeRage\Sys\Info under
     * construction</li>
     * <li>license - The copyright information for the CodeRage\Sys\Info under
     * construction</li>
    ...
    /**
     * Returns the copyright information for this CodeRage\Sys\Info
     *
     * @return string
     */
    function copyright()
    ...
    /**
     * Returns a newly constructed instance of CodeRage\Sys\Info, supplying
    ...
    /**
     * Constructs and returns an instance of CodeRage\Sys\Info from the given
     * 'info' element in an XML document conforming to the schema 'project.xsd'.
     *
     * @param DOMElement $info
     * @return CodeRage\Sys\Info
     */
